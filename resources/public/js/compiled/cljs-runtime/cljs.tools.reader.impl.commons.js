...
var G__26613 = rdr.cljs$tools$reader$reader_types$Reader$read_char$arity$1(null);
ch = G__26613;
continue;
} else {
return ch;
...
var vec__26581 = cljs.core.re_find(pattern,s);
var match = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26581,(0),null);
return (match === s);
});
...
/** @this {Function} */
cljs.tools.reader.impl.commons.read_comment.cljs$lang$applyTo = (function (seq26598){
...
return (function() { 
var G__26644__delegate = function (rdr,_){
...
var G__26644 = function (rdr,var_args){
var _ = null;
...
while (G__26645__i < G__26645__a.length) {G__26645__a[G__26645__i] = arguments[G__26645__i + 1]; ++G__26645__i;}
  _ = new cljs.core.IndexedSeq(G__26645__a,0,null);
} 
return G__26644__delegate.call(this,rdr,_);};
G__26644.cljs$lang$maxFixedArity = 1;
G__26644.cljs$lang$applyTo = (function (arglist__26647){
var rdr = cljs.core.first(arglist__26647);
var _ = cljs.core.rest(arglist__26647);
return G__26644__delegate(rdr,_);
});

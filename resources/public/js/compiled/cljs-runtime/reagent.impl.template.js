...
var G__25266_25319 = reagent.impl.template.prop_name_cache;
var G__25267_25320 = cljs.core.name(k);
goog.object.set(G__25266_25319,G__25267_25320);
...
var G__25269 = o;
var G__25270_25321 = G__25269;
var G__25271_25322 = reagent.impl.template.cached_prop_name(k);
var G__25272_25323 = (reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v));
goog.object.set(G__25270_25321,G__25271_25322,G__25272_25323);
...
while (G__25325__i < G__25325__a.length) {G__25325__a[G__25325__i] = arguments[G__25325__i + 0]; ++G__25325__i;}
  args = new cljs.core.IndexedSeq(G__25325__a,0,null);
} 
...
if((temp__5722__auto__ == null)){
var v = reagent.impl.util.dash_to_prop_name(k);
var G__25276_25327 = reagent.impl.template.custom_prop_name_cache;
var G__25277_25328 = cljs.core.name(k);
var G__25278_25329 = v;
goog.object.set(G__25276_25327,G__25277_25328,G__25278_25329);
...
var G__25280 = o;
var G__25281_25330 = G__25280;
var G__25282_25331 = reagent.impl.template.cached_custom_prop_name(k);
var G__25283_25332 = reagent.impl.template.convert_prop_value(v);
goog.object.set(G__25281_25330,G__25282_25331,G__25283_25332);
...
while (G__25334__i < G__25334__a.length) {G__25334__a[G__25334__i] = arguments[G__25334__i + 0]; ++G__25334__i;}
  args = new cljs.core.IndexedSeq(G__25334__a,0,null);
} 
...
var G__25284 = props;
var G__25284__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__25284,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__25284);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__25284__$1,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$2(class$,new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props)));
} else {
return G__25284__$1;
}
});
...
var props__$1 = reagent.impl.template.set_id_class((function (){var G__25286 = props;
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__25286,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$1(class$));
} else {
return G__25286;
}
})(),id_class);
...
reagent.impl.template.input_node_set_value = (function reagent$impl$template$input_node_set_value(node,rendered_value,dom_value,component,p__25287){
var map__25289 = p__25287;
var map__25289__$1 = (((((!((map__25289 == null))))?(((((map__25289.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__25289.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__25289):map__25289);
var on_write = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__25289__$1,new cljs.core.Keyword(null,"on-write","on-write",31519475));
...
return reagent.impl.batching.do_after_render(((function (node_value,map__25289,map__25289__$1,on_write){
return (function (){
...
});})(node_value,map__25289,map__25289__$1,on_write))
);
} else {
...
return reagent.impl.template.input_handle_change(this$,on_change,p1__25296_SHARP_);
});})(v,value,on_change))
;
} else {
return null;
...
var vec__25301 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__25301,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__25301,(1),null);
var className = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__25301,(2),null);
...
var temp__5724__auto___25350 = reagent.impl.template.key_from_vec(v);
if((temp__5724__auto___25350 == null)){
} else {
var key_25351 = temp__5724__auto___25350;
...
var temp__5724__auto___25352 = reagent.impl.template.key_from_vec(argv);
if((temp__5724__auto___25352 == null)){
} else {
var key_25353 = temp__5724__auto___25352;
jsprops.key = key_25353;
}
...
var G__25305 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [reagent.impl.template.reagent_input(),argv,component,jsprops,first_child], null),cljs.core.meta(argv));
return (reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1(G__25305) : reagent.impl.template.as_element.call(null,G__25305));
} else {
var temp__5724__auto___25354 = reagent.impl.template.get_key(cljs.core.meta(argv));
if((temp__5724__auto___25354 == null)){
} else {
var key_25355 = temp__5724__auto___25354;
jsprops.key = key_25355;
}
...
/** @this {Function} */
reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq25308){
var G__25309 = cljs.core.first(seq25308);
var seq25308__$1 = cljs.core.next(seq25308);
var self__4717__auto__ = this;
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__25309,seq25308__$1);
});
...
break;
default:
var G__25389 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.with_meta(v,null),(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null),cljs.core.meta(v));
v = G__25389;
continue;
...
var ctx = ({});
var vec__25312 = reagent.ratom.check_derefs(((function (ctx){
return (function (){
return reagent.impl.template.expand_seq_dev(x,ctx);
});})(ctx))
);
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__25312,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__25312,(1),null);
...
var G__25315 = (cljs.core.count(argv) - first_child);
switch (G__25315) {
case (0):
...
break;
case (1):
var G__25316 = component;
var G__25317 = jsprops;
var G__25318 = reagent.impl.template.as_element(cljs.core.nth.cljs$core$IFn$_invoke$arity$3(argv,first_child,null));
return module$node_modules$react$index.createElement(G__25316,G__25317,G__25318);

break;
default:
return module$node_modules$react$index.createElement.apply(null,cljs.core.reduce_kv(((function (G__25315){
